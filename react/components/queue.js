    ...
    render() {
        ...
        return(
            <div id="queueInfo" class="statistic-block block noselect">
                <div className="title"><strong>Waitlist Queue</strong></div>
                <table className="table table-striped table-sm noselect">
                    <tbody>
                        <tr>
                            <td className="tw60per"><i class="fas fa-info-circle" data-toggle="tooltip" data-title="This indicator does not include alts."></i> Your Position:</td>
                            <td>{this.props.queue.mainPos}</td>
                        </tr>
                        <tr>
                            <td className="tw60per"><i class="fas fa-info-circle" data-toggle="tooltip" data-title="This indicator does not include alts."></i> People Waiting:</td>
                            <td>{this.props.queue.totalMains}</td>
                        </tr>
                        <tr>
                            <td><i className="fas fa-info-circle" data-toggle="tooltip" data-title="The FC sees you as your first pilot on the waitlist."></i> Your Main:</td>
